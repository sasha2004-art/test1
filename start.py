...
def check_docker_installed():
    ...
    try:
        ...
        print(f"{Colors.WARNING}Этот проект требует Docker для работы. Пожалуйста, установите Docker Desktop и убедитесь, что он запущен.{Colors.ENDC}")
        print(f"Ссылка для скачивания: {Colors.UNDERLINE}https://www.docker.com/products/docker-desktop/{Colors.ENDC}\n")
        return False
